...
GameModeID_DataSelect =	id(GameMode_DataSelect) ; 32
...
; HJW: $20 entries to fix various crashes and loading issues
Plc_Buffer:			ds.b 6*$20	; Pattern load queue (each entry is 6 bytes)
Plc_Buffer_Only_End:
