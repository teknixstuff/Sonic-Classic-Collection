...
extern sprite_pattern* pat_movie3[];
...
extern sprite_pattern* z31b_pat_pocket[];
extern sprite_pattern* banpa_pat[];
extern sprite_pattern* z31b_togeball_pat[];
extern sprite_pattern* z31bbobinpat[];
extern sprite_pattern* frippat[];
extern sprite_pattern* springpat[];
extern sprite_pattern* itempat[];

edit_data z31b_edit_tbl = {
  26,
  0,
  {
    ...
    { 40, 1, drumr3pat,               910 },
    { 47, 1, z31b_pat_pocket,         957 },
    { 42, 1, banpa_pat,             17246 },
    { 44, 1, z31b_togeball_pat,       957 },
    { 29, 1, z31bbobinpat,           1230 },
    { 30, 1, frippat,                1181 },
